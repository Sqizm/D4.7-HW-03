...
#     if action == "post_add":
#         # Вызов задачи Celery через сигнал.
#         new_news_id = instance.id  # Так же извлекаю новую новость, но уже с полем id
#         notify_subscribers_task(new_news_id)  # Вызываю задачу отправ. уведомл. теперь от Celery.
#
